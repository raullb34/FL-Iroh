...
import asyncio, iroh, struct, hashlib, sys
...
async def main():
    ...
    for t in range(12):
        ...
        try:
            ...
            print(f"RESULT t={t} conn_type={ct} rtt={conn.rtt()}")
        except Exception as e:
            print(f"RESULT t={t} ERR {type(e).__name__}: {e}")
...
PY
echo "===RESULTS==="
grep -a "RESULT" /tmp/e3_timing.txt
