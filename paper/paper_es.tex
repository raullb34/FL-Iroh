...
AirMLP (FedAvg)           & Geogr\'{a}fica & 95,5\% & 5 \\
ProphetWrapper (FedGAM)   & IID         & --- & \emph{n/a} \\
ProphetWrapper (FedGAM)   & Geogr\'{a}fica & --- & \emph{n/a} \\
\bottomrule
\end{tabular}

\emph{Resultados AirMLP medidos emp\'{i}ricamente ($R{=}50$; etiquetas por terciles de NO$_2$ del conjunto de entrenamiento: Q1$=$7,5, Q2$=$13,0~$\mu$g/m$^3$). Resultados ProphetWrapper (FedGAM) pendientes de compilaci\'{o}n de cmdstan.}
\end{table}

\textbf{AgronomicAgnosticism.} El mismo plano de datos Iroh/QUIC y el plano de control CoAP transportan tanto tensores de pesos AirMLP (3,7K par\'{a}metros, $\approx$15~KB) como tensores Fourier de ProphetWrapper (26 par\'{a}metros, $<$1~KB) sin modificaci\'{o}n de protocolo. El \'{u}nico cambio de c\'{o}digo entre ambas configuraciones es pasar \texttt{aggregator\_fn=fedgam\_aggregate} al \texttt{FLServer}.
